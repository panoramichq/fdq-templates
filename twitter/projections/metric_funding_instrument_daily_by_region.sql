CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_FUNDING_INSTRUMENT_DAILY_BY_REGION" AS
...
SELECT 
    ...
    , COUNTRY_NAME::VARCHAR(256)                            AS COUNTRY_NAME
    , COUNTRY_TARGET_VALUE::VARCHAR(256)                    AS COUNTRY_TARGET_VALUE
    , SEGMENT::VARCHAR(256)                                 AS REGION
...
FROM "TWITTER_ADS"."FUNDING_INSTRUMENT_REGIONS_REPORT"
;
