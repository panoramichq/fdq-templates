CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_CAMPAIGN_DAILY_BY_REGION" AS
...
SELECT 
    ...
    , COUNTRY_NAME::VARCHAR(256)                            AS PLATFORM_NAME
    , COUNTRY_TARGET_VALUE::VARCHAR(256)                    AS PLATFORM_TARGET_VALUE
...
FROM "TWITTER_ADS"."CAMPAIGN_REGIONS_REPORT"
;
