CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_PROMOTED_TWEET_DAILY_BY_INTEREST" AS
...
SELECT 
    ...
    , SEGMENT::VARCHAR(256)                                 AS INTEREST
...
FROM "TWITTER_ADS"."PROMOTED_TWEET_INTERESTS_REPORT"
;
