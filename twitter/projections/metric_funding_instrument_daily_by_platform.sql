CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_FUNDING_INSTRUMENT_DAILY_BY_PLATFORM" AS
...
SELECT 
    ...
    , SEGMENT::VARCHAR(256)                                 AS PLATFORM
...
FROM "TWITTER_ADS"."FUNDING_INSTRUMENT_PLATFORMS_REPORT"
;
