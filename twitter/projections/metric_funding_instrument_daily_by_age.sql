CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_FUNDING_INSTRUMENT_DAILY_BY_AGE" AS
...
SELECT 
    ...
    , SEGMENT::VARCHAR(256)                                 AS AGE_BUCKET
...
FROM "TWITTER_ADS"."FUNDING_INSTRUMENT_AGE_REPORT"
;
