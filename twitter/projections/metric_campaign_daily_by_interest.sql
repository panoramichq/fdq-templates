CREATE OR REPLACE VIEW "TWITTER_ADS_VIEWS"."METRIC_CAMPAIGN_DAILY_BY_INTEREST" AS
...
SELECT 
	...
	, SEGMENT::VARCHAR(256)                                 AS INTERESTS
...
FROM "TWITTER_ADS"."CAMPAIGN_INTERESTS_REPORT"
;
