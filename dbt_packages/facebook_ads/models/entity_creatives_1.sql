...
SELECT
	...
	, ACTOR_ID::VARCHAR     						AS ACTOR_ID
	, EFFECTIVE_INSTAGRAM_STORY_ID::VARCHAR     	AS EFFECTIVE_INSTAGRAM_STORY_ID
	...
	, INSTAGRAM_STORY_ID::VARCHAR   				AS INSTAGRAM_STORY_ID
	, LINK_OG_ID::VARCHAR   						AS LINK_OG_ID
	...
	, PRODUCT_SET_ID::VARCHAR   					AS PRODUCT_SET_ID
	...
	, BRANDED_CONTENT_SPONSOR_PAGE_ID::VARCHAR  	AS BRANDED_CONTENT_SPONSOR_PAGE_ID
...
FROM
  (
	...
	FROM {{ source('FACEBOOK', 'CREATIVE_HISTORY') }}
    -- FROM
