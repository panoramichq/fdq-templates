CREATE OR REPLACE VIEW "FACEBOOK_VIEWS"."METRIC_ADS_DAILY" AS
SELECT
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_30_SEC_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_AVG_TIME_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_PLAY_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_P_25_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_P_50_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_P_75_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_P_95_WATCHED_ACTIONS"
...
LEFT JOIN (
  ...
  FROM "FACEBOOK"."BASIC_VIDEO_P_100_WATCHED_ACTIONS"
